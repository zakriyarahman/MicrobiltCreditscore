...
/**
 * File for class IntlCourtDetailsInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for IntlCourtDetailsInfo_Type originally named IntlCourtDetailsInfo_Type
 ...
 * @date 2015-11-26
 */
class IntlCourtDetailsInfo_Type extends Aggregate
{
    /**
     * The MsgClass
     * Meta informations extracted from the WSDL
