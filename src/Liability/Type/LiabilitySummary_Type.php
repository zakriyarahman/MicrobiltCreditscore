...
/**
 * File for class LiabilitySummary_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LiabilitySummary_Type originally named LiabilitySummary_Type
 ...
 * @date 2015-11-26
 */
class LiabilitySummary_Type extends Aggregate
{
    /**
     * The MsgClass
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_totalBalanceAmt
     * @param CurrencyAmount $_totalScheduledMoPmtAmt
     * @param CurrencyAmount $_totalHC_CLAmt
     * @param int $_lateCount30
     * @param int $_lateCount60
     * @param int $_lateCount90
     * @param float $_availablePercentage
     * @return LiabilitySummary_Type
     */
     ...
     * @param CurrencyAmount $_totalBalanceAmt the TotalBalanceAmt
     ...
     * @param CurrencyAmount $_totalScheduledMoPmtAmt the TotalScheduledMoPmtAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_totalHC_CLAmt the TotalHC_CLAmt
     * @return CurrencyAmount
     */
