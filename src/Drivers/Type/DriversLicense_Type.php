...
/**
 * File for class DriversLicense_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DriversLicense_Type originally named DriversLicense_Type
 ...
 * @date 2015-11-26
 */
class DriversLicense_Type extends Aggregate
{
    /**
     * The LicenseNum
     * Meta informations extracted from the WSDL
     ...
     * @param CodeDescription_Type $_driverOption
     * @param string $_dLClass
     * @param string $_dLType
     * @param string $_dLStatus
     * @param string $_cDLStatus
     * @param Option_Type $_endorsements
     * @param Option_Type $_restrictions
     ...
     * @param CodeDescription_Type $_driverOption the DriverOption
     ...
     * @param Option_Type $_endorsements the Endorsements
     * @return Option_Type
     */
     ...
     * @param Option_Type $_restrictions the Restrictions
     * @return Option_Type
     */
