...
/**
 * File for class CorporateDemographicInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CorporateDemographicInfo_Type originally named CorporateDemographicInfo_Type
 ...
 * @date 2015-11-26
 */
class CorporateDemographicInfo_Type extends Aggregate
{
    /**
     * The IndustId
     * Meta informations extracted from the WSDL
     ...
     * @param MinMaxRange_Type $_yearsInBusinessRange
     * @param CommercialAmounts_Type $_commercialAmounts
     * @param MinMaxRange_Type $_numEmployeesRange
     ...
     * @return CorporateDemographicInfo_Type
     */
     ...
     * @param MinMaxRange_Type $_yearsInBusinessRange the YearsInBusinessRange
     ...
     * @param MinMaxRange_Type $_numEmployeesRange the NumEmployeesRange
     * @return MinMaxRange_Type
     */
