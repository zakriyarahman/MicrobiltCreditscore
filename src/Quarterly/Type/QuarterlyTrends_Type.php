...
/**
 * File for class QuarterlyTrends_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QuarterlyTrends_Type originally named QuarterlyTrends_Type
 ...
 * @date 2015-11-26
 */
class QuarterlyTrends_Type extends Aggregate
{
    /**
     * The YearOfQuarter
     * Meta informations extracted from the WSDL
     ...
     * @param PastDuePeriods_Type $_pastDuePeriods
     * @param string $_numSuppliers
     * @return QuarterlyTrends_Type
     */
     ...
     * @return PastDuePeriods_Type|null
     */
     ...
     * @param PastDuePeriods_Type $_pastDuePeriods the PastDuePeriods
