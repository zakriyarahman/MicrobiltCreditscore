 ...
 * @date 2015-11-26
 */
class Accident_Type extends Aggregate
{
    /**
     * The AccidentDt
     * Meta informations extracted from the WSDL
     ...
     * @param AccidentLocation_Type $_accidentLocation
     * @param PostAddr_Type $_location
     * @param string $_damage
     * @param OrgInfo_Type $_agency
     * @param string $_filingDt
     * @param string $_typeFRCase
     * @param string $_action
     * @param AccidentTime_Type $_accidentTime
     ...
     * @param Conditions_Type $_conditions
     * @param Investigation_Type $_investigation
     * @param AccidentStatistics_Type $_accidentStatistics
     ...
     * @return AccidentLocation_Type|null
     */
     ...
     * @param AccidentLocation_Type $_accidentLocation the AccidentLocation
     * @return AccidentLocation_Type
     */
    ...
    /**
     * Set Location value
     * @param PostAddr_Type $_location the Location
     ...
     * @param AccidentTime_Type $_accidentTime the AccidentTime
     * @return AccidentTime_Type
     */
     ...
     * @param Conditions_Type $_conditions the Conditions
     ...
     * @return Investigation_Type|null
     */
     ...
     * @param Investigation_Type $_investigation the Investigation
     ...
     * @return AccidentStatistics_Type|null
     */
     ...
     * @param AccidentStatistics_Type $_accidentStatistics the AccidentStatistics
