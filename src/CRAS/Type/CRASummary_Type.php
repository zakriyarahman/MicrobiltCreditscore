...
/**
 * File for class CRASummary_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CRASummary_Type originally named CRASummary_Type
 ...
 * @date 2015-11-26
 */
class CRASummary_Type extends Aggregate
{
    /**
     * The MsgClass
     * Meta informations extracted from the WSDL
     ...
     * @param CodeDescription_Type $_maxDelinquencyEver
     * @param string $_monthsSinceMostRecentDelinquency
     * @param int $_creditObligationsWithBalanceCount
     * @param CurrencyAmount $_totalBalancesOnCRAmt
     * @return CRASummary_Type
     */
     ...
     * @param CodeDescription_Type $_maxDelinquencyEver the MaxDelinquencyEver
     ...
     * @param CurrencyAmount $_totalBalancesOnCRAmt the TotalBalancesOnCRAmt
