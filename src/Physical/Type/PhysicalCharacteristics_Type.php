...
/**
 * File for class PhysicalCharacteristics_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PhysicalCharacteristics_Type originally named PhysicalCharacteristics_Type
 ...
 * @date 2015-11-26
 */
class PhysicalCharacteristics_Type extends Aggregate
{
    /**
     * The Age
     * Meta informations extracted from the WSDL
     ...
     * @param Boolean $_correctiveLenses
     ...
     * @param Boolean $_correctiveLenses the CorrectiveLenses
     * @return Boolean
     */
    public function setCorrectiveLenses($_correctiveLenses)
    {
        if(!Boolean::valueIsValid($_correctiveLenses))
        {
            return false;
        }
