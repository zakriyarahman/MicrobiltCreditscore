...
namespace Zakriyarahman\Microbilt\Acct\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class AcctAttributeInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 * @date 2015-11-26
 */
class AcctAttributeInfo_Type extends Aggregate
{
    /**
     * The AttribName
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_attribAmt
     * @param string $_attribDt
     * @return AcctAttributeInfo_Type
     */
    ...
    /**
     * Set AttribAmt value
     * @param CurrencyAmount $_attribAmt the AttribAmt
