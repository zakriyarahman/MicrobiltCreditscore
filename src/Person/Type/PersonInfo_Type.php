 ...
 * @date 2015-11-26
 */
class PersonInfo_Type extends Aggregate
{
    /**
     * The PersonName
     * Meta informations extracted from the WSDL
     ...
     * - maxOccurs : 1
     * - minOccurs : 0
     * @var PhysicalCharacteristics_Type
     */
     ...
     * @param DriversLicense_Type $_driversLicense
     * @param string $_mothersMaidenName
     * @param SpouseInfo_Type $_spouseInfo
     * @param EmploymentHistory_Type $_employmentHistory
     * @param SchoolInfo_Type $_schoolInfo
     * @param PhysicalCharacteristics_Type $_physicalCharacteristics
     ...
     * @param MilitaryIdInfo_Type $_militaryIdInfo
     * @param PassportInfo_Type $_passportInfo
     * @param ChildrenInfo_Type $_childrenInfo
     * @param string $_hometownArea
     * @param string $_relationshipStatus
     * @param string $_orientation
     * @param AKAInfo_Type $_aKAInfo
     ...
     * @return DriversLicense_Type|null
     */
     ...
     * @param DriversLicense_Type $_driversLicense the DriversLicense
     * @return DriversLicense_Type
     */
     ...
     * @param SpouseInfo_Type $_spouseInfo the SpouseInfo
     * @return SpouseInfo_Type
     */
     ...
     * @return EmploymentHistory_Type|null
     */
     ...
     * @param EmploymentHistory_Type $_employmentHistory the EmploymentHistory
     ...
     * @param SchoolInfo_Type $_schoolInfo the SchoolInfo
     ...
     * @return PhysicalCharacteristics_Type|null
     */
     ...
     * @param PhysicalCharacteristics_Type $_physicalCharacteristics the PhysicalCharacteristics
     * @return PhysicalCharacteristics_Type
     */
     ...
     * @return MilitaryIdInfo_Type|null
     */
     ...
     * @param MilitaryIdInfo_Type $_militaryIdInfo the MilitaryIdInfo
     * @return MilitaryIdInfo_Type
     */
     ...
     * @param PassportInfo_Type $_passportInfo the PassportInfo
     * @return PassportInfo_Type
     */
     ...
     * @param ChildrenInfo_Type $_childrenInfo the ChildrenInfo
     * @return ChildrenInfo_Type
     */
    ...
    /**
     * Set AKAInfo value
     * @param AKAInfo_Type $_aKAInfo the AKAInfo
     * @return AKAInfo_Type
     */
