...
/**
 * File for class PaymentInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PaymentInfo_Type originally named PaymentInfo_Type
 ...
 * @date 2015-11-26
 */
class PaymentInfo_Type extends Aggregate
{
    /**
     * The MsgClass
     * Meta informations extracted from the WSDL
     ...
     * @param CategoryInfo_Type $_categoryInfo
     * @param ElementsInfo_Type $_paymentElementsInfo
     ...
     * @param CategoryInfo_Type $_categoryInfo the CategoryInfo
     * @return CategoryInfo_Type
     */
     ...
     * @param ElementsInfo_Type $_paymentElementsInfo the PaymentElementsInfo
