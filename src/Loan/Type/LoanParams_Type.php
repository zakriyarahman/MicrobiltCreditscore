...
/**
 * File for class LoanParams_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LoanParams_Type originally named LoanParams_Type
 ...
 * @date 2015-11-26
 */
class LoanParams_Type extends Aggregate
{
    /**
     * The RequestedAmt
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_requestedAmt
     * @param CurrencyAmount $_feeAmt
     * @param string $_dueDate
     * @param Boolean $_renewal
     * @param Boolean $_rollover
     ...
     * @param CurrencyAmount $_alternativeLoanAmt
     * @param CurrencyAmount $_approvalAmt
     * @param string $_name
     * @param string $_error
     ...
     * @param CurrencyAmount $_requestedAmt the RequestedAmt
    ...
    /**
     * Set FeeAmt value
     * @param CurrencyAmount $_feeAmt the FeeAmt
     * @return CurrencyAmount
     */
     ...
     * @param Boolean $_renewal the Renewal
     * @return Boolean
     */
    public function setRenewal($_renewal)
    {
        if(!Boolean::valueIsValid($_renewal))
        {
            return false;
        }
     ...
     * Set Rollover value
     * @uses Boolean::valueIsValid()
     * @param Boolean $_rollover the Rollover
     * @return Boolean
     */
    public function setRollover($_rollover)
    {
        if(!Boolean::valueIsValid($_rollover))
        {
            return false;
        }
     ...
     * @param CurrencyAmount $_alternativeLoanAmt the AlternativeLoanAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_approvalAmt the ApprovalAmt
     * @return CurrencyAmount
     */
