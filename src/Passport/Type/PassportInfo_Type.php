...
namespace Zakriyarahman\Microbilt\Passport\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class PassportInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PassportInfo_Type originally named PassportInfo_Type
 ...
 * @date 2015-11-26
 */
class PassportInfo_Type extends Aggregate
{
    /**
     * The Country
     * Meta informations extracted from the WSDL
