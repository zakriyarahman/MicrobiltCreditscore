...
/**
 * File for class EconomicInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for EconomicInfo_Type originally named EconomicInfo_Type
 ...
 * @date 2015-11-26
 */
class EconomicInfo_Type extends Aggregate
{
    /**
     * The Message
     * Meta informations extracted from the WSDL
