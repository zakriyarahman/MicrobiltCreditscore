...
namespace Zakriyarahman\Microbilt\Attachment_\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class Attachment_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for Attachment_Type originally named Attachment_Type
 ...
 * @date 2015-11-26
 */
class Attachment_Type extends Aggregate
{
    /**
     * The ContentType
     * Meta informations extracted from the WSDL
