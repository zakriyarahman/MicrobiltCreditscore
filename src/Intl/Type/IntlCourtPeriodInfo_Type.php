...
/**
 * File for class IntlCourtPeriodInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for IntlCourtPeriodInfo_Type originally named IntlCourtPeriodInfo_Type
 ...
 * @date 2015-11-26
 */
class IntlCourtPeriodInfo_Type extends Aggregate
{
    /**
     * The MsgClass
     * Meta informations extracted from the WSDL
