...
/**
 * File for class OfficersDirectors_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for OfficersDirectors_Type originally named OfficersDirectors_Type
 ...
 * @date 2015-11-26
 */
class OfficersDirectors_Type extends Aggregate
{
    /**
     * The PersonInfo
     * Meta informations extracted from the WSDL
     ...
     * @param Boolean $_historicalInd the HistoricalInd
     * @return Boolean
     */
    public function setHistoricalInd($_historicalInd)
    {
        if(!Boolean::valueIsValid($_historicalInd))
        {
            return false;
        }
