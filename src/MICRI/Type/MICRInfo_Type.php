 ...
 */
/**
 * This class stands for MICRInfo_Type originally named MICRInfo_Type
 ...
 * @date 2015-11-26
 */
class MICRInfo_Type extends Aggregate
{
    /**
     * The MICRType
     * Meta informations extracted from the WSDL
     ...
     * @param Boolean $_swipedInd
     * @param string $_fullMICRLine
     * @return MICRInfo_Type
     */
     ...
     * @param Boolean $_swipedInd the SwipedInd
     * @return Boolean
     */
    public function setSwipedInd($_swipedInd)
    {
        if(!Boolean::valueIsValid($_swipedInd))
        {
            return false;
        }
