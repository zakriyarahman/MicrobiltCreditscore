...
namespace Zakriyarahman\Microbilt\QFP\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class QFProdOffer_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QFProdOffer_Type originally named QFProdOffer_Type
 ...
 * @date 2015-11-26
 */
class QFProdOffer_Type extends Aggregate
{
    /**
     * The MsgClass
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_prodOfferLmtAmt
     ...
     * @param CurrencyAmount $_prodOfferLmtAmt the ProdOfferLmtAmt
