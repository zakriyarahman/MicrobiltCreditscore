...
namespace Zakriyarahman\Microbilt\Get\Response;

use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class GetArchiveReportResponse
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for GetArchiveReportResponse originally named GetArchiveReportResponse
 ...
 * @date 2015-11-26
 */
class GetArchiveReportResponse extends MicrobiltWsdlClass
{
    /**
     ...
     * @param ExStdRs_Type $_getArchiveReportResult
     ...
     * @param ExStdRs_Type $_getArchiveReportResult the GetArchiveReportResult
     * @return ExStdRs_Type
     */
