...
/**
 * File for class LienHolderInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LienHolderInfo_Type originally named LienHolderInfo_Type
 ...
 * @date 2015-11-26
 */
class LienHolderInfo_Type extends Aggregate
{
    /**
     * The LienHolderType
     * Meta informations extracted from the WSDL
