...
/**
 * File for class CommercialUCCSummary_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CommercialUCCSummary_Type originally named CommercialUCCSummary_Type
 ...
 * @date 2015-11-26
 */
class CommercialUCCSummary_Type extends Aggregate
{
    /**
     ...
     * - maxOccurs : unbounded
     * - minOccurs : 0
     * @var SummaryCountTimeFrame_Type
     */
     ...
     * @param SummaryCountTimeFrame_Type $_summaryCountTimeFrame
     * @return CommercialUCCSummary_Type
     */
     ...
     * @return SummaryCountTimeFrame_Type|null
     */
     ...
     * @param SummaryCountTimeFrame_Type $_summaryCountTimeFrame the SummaryCountTimeFrame
     * @return SummaryCountTimeFrame_Type
     */
