...
use Zakriyarahman\Microbilt\Summary\Type\SummaryCharacteristics_Type;

/**
 * File for class SummaryCharacteristics
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SummaryCharacteristics originally named SummaryCharacteristics
 ...
 * @date 2015-11-26
 */
class SummaryCharacteristics extends SummaryCharacteristics_Type
{
    /**
     * The Quantity
     * Meta informations extracted from the WSDL
     ...
     * @param CodeDescription_Type $_characteristics
     ...
     * @param CodeDescription_Type $_characteristics the Characteristics
