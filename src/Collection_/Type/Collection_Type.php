...
/**
 * File for class Collection_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for Collection_Type originally named Collection_Type
 ...
 * @date 2015-11-26
 */
class Collection_Type extends Aggregate
{
    /**
     * The OrigCreditor
     * Meta informations extracted from the WSDL
     ...
     * @param OrgInfo_Type $_collectionAgency
     * @param string $_assignedDt
     * @param CurrencyAmount $_currentAmt
     * @param string $_balanceDt
     * @param CodeDescription_Type $_collectionStatus
     ...
     * @param OrgInfo_Type $_collectionAgency the CollectionAgency
     * @return OrgInfo_Type
     */
     ...
     * @param CodeDescription_Type $_collectionStatus the CollectionStatus
