...
namespace Zakriyarahman\Microbilt\Date\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class DateRange_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DateRange_Type originally named DateRange_Type
 ...
 * @date 2015-11-26
 */
class DateRange_Type extends Aggregate
{
    /**
     * The StartDt
     * Meta informations extracted from the WSDL
