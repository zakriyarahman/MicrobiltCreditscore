...
/**
 * File for class FraudValidations_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for FraudValidations_Type originally named FraudValidations_Type
 ...
 * @date 2015-11-26
 */
class FraudValidations_Type extends Aggregate
{
    /**
     * The NameValidation
     * Meta informations extracted from the WSDL
     ...
     * @param Message_Type $_comboValidation
     * @param Message_Type $_businessValidation
     ...
     * @param Message_Type $_comboValidation the ComboValidation
     * @return Message_Type
     */
     ...
     * @param Message_Type $_businessValidation the BusinessValidation
     * @return Message_Type
     */
