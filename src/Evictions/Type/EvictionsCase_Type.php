...
/**
 * File for class EvictionsCase_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for EvictionsCase_Type originally named EvictionsCase_Type
 ...
 * @date 2015-11-26
 */
class EvictionsCase_Type extends Aggregate
{
    /**
     * The CaseId
     * Meta informations extracted from the WSDL
     ...
     * @param Message_Type $_evictionsData
     ...
     * @param Message_Type $_evictionsData the EvictionsData
     * @return Message_Type
     */
