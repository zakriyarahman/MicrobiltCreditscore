...
/**
 * File for class DebtSummary_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DebtSummary_Type originally named DebtSummary_Type
 ...
 * @date 2015-11-26
 */
class DebtSummary_Type extends Aggregate
{
    /**
     * The Message
     * Meta informations extracted from the WSDL
