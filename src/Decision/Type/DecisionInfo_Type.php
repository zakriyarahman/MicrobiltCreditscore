...
/**
 * File for class DecisionInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DecisionInfo_Type originally named DecisionInfo_Type
 ...
 * @date 2015-11-26
 */
class DecisionInfo_Type extends Aggregate
{
    /**
     * The ProductType
     * Meta informations extracted from the WSDL
     ...
     * @param CodeDescription_Type $_productInfo
     * @param Decision_Type $_decision
     * @param VariableInfo_Type $_variableInfo
     * @param PathInfo_Type $_pathInfo
     * @return DecisionInfo_Type
     */
     ...
     * @param CodeDescription_Type $_productInfo the ProductInfo
     ...
     * @param VariableInfo_Type $_variableInfo the VariableInfo
     * @return VariableInfo_Type
     */
    ...
    /**
     * Set PathInfo value
     * @param PathInfo_Type $_pathInfo the PathInfo
