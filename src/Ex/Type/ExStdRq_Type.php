 ...
 */
/**
 * This class stands for ExStdRq_Type originally named ExStdRq_Type
 ...
 * @date 2015-11-26
 */
class ExStdRq_Type extends MicrobiltWsdlClass
{
    /**
     * The MsgRqHdr
     * @var MsgRqHdr_Type
     ...
     * @param MsgRqHdr_Type $_msgRqHdr
     * @param MicrobiltStructPersonInfo_Type $_personInfo
     * @param LoanRequestInfo_Type $_loanRequestInfo
    ...
    /**
     * Set MsgRqHdr value
     * @param MsgRqHdr_Type $_msgRqHdr the MsgRqHdr
     ...
     * @return LoanRequestInfo_Type|null
     */
     ...
     * @param LoanRequestInfo_Type $_loanRequestInfo the LoanRequestInfo
