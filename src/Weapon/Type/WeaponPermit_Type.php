...
/**
 * File for class WeaponPermit_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for WeaponPermit_Type originally named WeaponPermit_Type
 ...
 * @date 2015-11-26
 */
class WeaponPermit_Type extends Aggregate
{
    /**
     * The PersonInfo
     * Meta informations extracted from the WSDL
