 ...
 */
/**
 * This class stands for MapResponse originally named MapResponse
 ...
 * @date 2015-11-26
 */
class MapResponse extends MicrobiltWsdlClass
{
    /**
     * The MapResult
     * Meta informations extracted from the WSDL
    ...
    /**
     * Set MapResult value
     * @param ExStdRs_Type $_mapResult the MapResult
     * @return ExStdRs_Type
     */
