 ...
 */
/**
 * This class stands for MsgRsHdr_Type originally named MsgRsHdr_Type
 ...
 * @date 2015-11-26
 */
class MsgRsHdr_Type extends MicrobiltWsdlClass
{
    /**
     * The RqUID
     * Meta informations extracted from the WSDL
    ...
    /**
     * Set Status value
     * @param Status_Type $_status the Status
     * @return Status_Type
     */
