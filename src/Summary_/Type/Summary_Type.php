 ...
 */
/**
 * This class stands for Summary_Type originally named Summary_Type
 ...
 * @date 2015-11-26
 */
class Summary_Type extends Aggregate
{
    /**
     * The BalanceAmt
     * Meta informations extracted from the WSDL
     ...
     * @param CompAmt_Type $_pastDueBalAmt
     * @param CompAmt_Type $_paymentAmt
     * @param CompAmt_Type $_realEstateBalAmt
     * @param CompAmt_Type $_realEstatePmtAmt
     * @param CompAmt_Type $_totalCreditLimitAmt
     ...
     * @param CurrencyAmount $_averageMonthlyPmtAmt
     * @param int $_derogCount
     * @param OtherAmounts_Type $_otherAmounts
     * @param OtherPercentages_Type $_otherPercentages
     * @return Summary_Type
     */
     ...
     * @param CompAmt_Type $_pastDueBalAmt the PastDueBalAmt
     * @return CompAmt_Type
     */
     ...
     * @param CompAmt_Type $_paymentAmt the PaymentAmt
     * @return CompAmt_Type
     */
     ...
     * @param CompAmt_Type $_realEstateBalAmt the RealEstateBalAmt
     * @return CompAmt_Type
     */
     ...
     * @param CompAmt_Type $_realEstatePmtAmt the RealEstatePmtAmt
     * @return CompAmt_Type
     */
     ...
     * @param CompAmt_Type $_totalCreditLimitAmt the TotalCreditLimitAmt
     * @return CompAmt_Type
     */
     ...
     * @param CurrencyAmount $_averageMonthlyPmtAmt the AverageMonthlyPmtAmt
     ...
     * @param OtherAmounts_Type $_otherAmounts the OtherAmounts
     * @return OtherAmounts_Type
     */
     ...
     * @return OtherPercentages_Type|null
     */
     ...
     * @param OtherPercentages_Type $_otherPercentages the OtherPercentages
