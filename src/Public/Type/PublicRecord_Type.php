...
/**
 * File for class PublicRecord_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PublicRecord_Type originally named PublicRecord_Type
 ...
 * @date 2015-11-26
 */
class PublicRecord_Type extends Aggregate
{
    /**
     * The CaseId
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_bankruptcyAssetsAmt
     * @param CurrencyAmount $_bankruptcyLiabilitiesAmt
     ...
     * @param CurrencyAmount $_legalObligationAmt
     * @param Boolean $_manualUpdInd
     ...
     * @param CurrencyAmount $_bankruptcyAssetsAmt the BankruptcyAssetsAmt
     ...
     * @param CurrencyAmount $_bankruptcyLiabilitiesAmt the BankruptcyLiabilitiesAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_legalObligationAmt the LegalObligationAmt
     * @return CurrencyAmount
     */
     ...
     * @uses Boolean::valueIsValid()
     * @param Boolean $_manualUpdInd the ManualUpdInd
     * @return Boolean
     */
    public function setManualUpdInd($_manualUpdInd)
    {
        if(!Boolean::valueIsValid($_manualUpdInd))
        {
            return false;
        }
     ...
     * @uses Boolean::valueIsValid()
     * @param Boolean $_voluntaryInd the VoluntaryInd
     * @return Boolean
     */
    public function setVoluntaryInd($_voluntaryInd)
    {
        if(!Boolean::valueIsValid($_voluntaryInd))
        {
            return false;
        }
    ...
    /**
     * Set ClaimAmt value
     * @param CurrencyAmount $_claimAmt the ClaimAmt
     * @return CurrencyAmount
     */
    ...
    /**
     * Set CourtInfo value
     * @param CourtInfo_Type $_courtInfo the CourtInfo
     * @return CourtInfo_Type
     */
