...
/**
 * File for class DecisionTableDetails_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DecisionTableDetails_Type originally named DecisionTableDetails_Type
 ...
 * @date 2015-11-26
 */
class DecisionTableDetails_Type extends Aggregate
{
    /**
     * The Function
     * Meta informations extracted from the WSDL
     ...
     * @param Boolean $_passed the Passed
     * @return Boolean
     */
    public function setPassed($_passed)
    {
        if(!Boolean::valueIsValid($_passed))
        {
            return false;
        }
