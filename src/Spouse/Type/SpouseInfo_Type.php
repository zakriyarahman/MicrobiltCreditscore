...
namespace Zakriyarahman\Microbilt\Spouse\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class SpouseInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SpouseInfo_Type originally named SpouseInfo_Type
 ...
 * @date 2015-11-26
 */
class SpouseInfo_Type extends Aggregate
{
    /**
     * The PersonName
     * Meta informations extracted from the WSDL
