...
namespace Zakriyarahman\Microbilt\Status_\Type;

use Zakriyarahman\Microbilt\MicrobiltWsdlClass;
use Zakriyarahman\Microbilt\Severity_\Type\Severity_Type;

/**
 * File for class Status_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for Status_Type originally named Status_Type
 ...
 * @date 2015-11-26
 */
class Status_Type extends MicrobiltWsdlClass
{
    /**
     * The StatusCode
     * Meta informations extracted from the WSDL
     ...
     * @param Severity_Type $_severity
     * @param string $_serverStatusCode
     * @param string $_statusDesc
     * @param AdditionalStatus_Type $_additionalStatus
     * @return Status_Type
     */
    ...
    /**
     * Set Severity value
     * @uses Severity_Type::valueIsValid()
     * @param Severity_Type $_severity the Severity
     * @return Severity_Type
     */
    public function setSeverity($_severity)
    {
        if(!Severity_Type::valueIsValid($_severity))
        {
            return false;
        }
     ...
     * @return AdditionalStatus_Type|null
     */
     ...
     * @param AdditionalStatus_Type $_additionalStatus the AdditionalStatus
     * @return AdditionalStatus_Type
     */
