...
namespace Zakriyarahman\Microbilt\Data\Type;
...
/**
 * File for class DataIndicators_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DataIndicators_Type originally named DataIndicators_Type
 ...
 * @date 2015-11-26
 */
class DataIndicators_Type extends Aggregate
{
    /**
     * The IndValue
     * Meta informations extracted from the WSDL
     ...
     * @param Boolean $_indValue the IndValue
     * @return Boolean
     */
    public function setIndValue($_indValue)
    {
        if(!Boolean::valueIsValid($_indValue))
        {
            return false;
        }
