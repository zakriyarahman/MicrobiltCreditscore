...
/**
 * File for class InformationSummary_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for InformationSummary_Type originally named InformationSummary_Type
 ...
 * @date 2015-11-26
 */
class InformationSummary_Type extends Aggregate
{
    /**
     ...
     * - maxOccurs : unbounded
     * - minOccurs : 0
     * @var InformationDetail_Type
     */
    public $InformationDetail;
    /**
     * Constructor method for InformationSummary_Type
     * @see parent::__construct()
     * @param InformationDetail_Type $_informationDetail
     * @return InformationSummary_Type
     */
     ...
     * @return InformationDetail_Type|null
     */
     ...
     * @param InformationDetail_Type $_informationDetail the InformationDetail
     * @return InformationDetail_Type
     */
