...
/**
 * File for class CreditCardInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CreditCardInfo_Type originally named CreditCardInfo_Type
 ...
 * @date 2015-11-26
 */
class CreditCardInfo_Type extends Aggregate
{
    /**
     * The ExpirationDt
     * Meta informations extracted from the WSDL
