...
/**
 * File for class CorpInquiry_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CorpInquiry_Type originally named CorpInquiry_Type
 ...
 * @date 2015-11-26
 */
class CorpInquiry_Type extends Aggregate
{
    /**
     * The BusCatagory
     * Meta informations extracted from the WSDL
     ...
     * @param InqCountInfo_Type $_inqCountInfo
     * @return CorpInquiry_Type
     */
     ...
     * @param InqCountInfo_Type $_inqCountInfo the InqCountInfo
