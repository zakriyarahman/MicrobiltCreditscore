...
/**
 * File for class VesselInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for VesselInfo_Type originally named VesselInfo_Type
 ...
 * @date 2015-11-26
 */
class VesselInfo_Type extends Aggregate
{
    /**
     ...
     * @param CodeDescription_Type $_vesselPropulsionType
     * @param string $_boatDescription
     * @param CodeDescription_Type $_hullMaterialType
     * @param int $_lengthFeet
     * @param CodeDescription_Type $_vesselType
     ...
     * @param CodeDescription_Type $_vesselPropulsionType the VesselPropulsionType
     ...
     * @param CodeDescription_Type $_hullMaterialType the HullMaterialType
     * @return CodeDescription_Type
     */
     ...
     * @param CodeDescription_Type $_vesselType the VesselType
     * @return CodeDescription_Type
     */
