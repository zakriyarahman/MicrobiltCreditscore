...
namespace Zakriyarahman\Microbilt\Court\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class CourtInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CourtInfo_Type originally named CourtInfo_Type
 ...
 * @date 2015-11-26
 */
class CourtInfo_Type extends Aggregate
{
    /**
     * The CourtType
     * Meta informations extracted from the WSDL
     ...
     * @param string $_fine
     * @param CodeDescription_Type $_riskLevel
     * @param string $_plea
    ...
    /**
     * Set RiskLevel value
     * @param CodeDescription_Type $_riskLevel the RiskLevel
