...
/**
 * File for class IntlCourtElementsInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for IntlCourtElementsInfo_Type originally named IntlCourtElementsInfo_Type
 ...
 * @date 2015-11-26
 */
class IntlCourtElementsInfo_Type extends Aggregate
{
    /**
     * The MsgClass
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_intlCourtAmt
     ...
     * @param CurrencyAmount $_intlCourtAmt the IntlCourtAmt
