...
namespace Zakriyarahman\Microbilt\Available\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class AvailableProducts_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for AvailableProducts_Type originally named AvailableProducts_Type
 ...
 * @date 2015-11-26
 */
class AvailableProducts_Type extends Aggregate
{
    /**
     * The ServiceSpeed
     * Meta informations extracted from the WSDL
