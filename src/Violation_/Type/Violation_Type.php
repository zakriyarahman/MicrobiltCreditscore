...
namespace Zakriyarahman\Microbilt\Violation_\Type;
 ...
 */
/**
 * This class stands for Violation_Type originally named Violation_Type
 ...
 * @date 2015-11-26
 */
class Violation_Type extends Aggregate
{
    /**
     * The ViolationDt
     * Meta informations extracted from the WSDL
     ...
     * @param Boolean $_hazMat the HazMat
     * @return Boolean
     */
    public function setHazMat($_hazMat)
    {
        if(!Boolean::valueIsValid($_hazMat))
        {
            return false;
        }
