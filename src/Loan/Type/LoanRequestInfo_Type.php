...
/**
 * File for class LoanRequestInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for LoanRequestInfo_Type originally named LoanRequestInfo_Type
 ...
 * @date 2015-11-26
 */
class LoanRequestInfo_Type extends Aggregate
{
    /**
     ...
     * @param CurrencyAmount $_requestedCreditAmt
     * @param CurrencyAmount $_downPmtAmt
     * @param CurrencyAmount $_monthlyPmtAmt
     * @param string $_terms
     * @param string $_refinanceCode
     * @param CurrencyAmount $_bookValueAmt
     * @param CurrencyAmount $_costOfGoodsAmt
     * @param CurrencyAmount $_totalLiquidAssetsAmt
     * @param string $_housingType
     * @param string $_dwellingStructureType
     * @param CurrencyAmount $_mortgageRentAmt
     * @param CurrencyAmount $_mortgageAmt
     * @param CurrencyAmount $_mortgageBalAmt
     * @param string $_loanType
     * @param CurrencyAmount $_monthlyDebtAmt
     * @param Boolean $_bankruptcyOnApp
     * @param Boolean $_repossessionOnApp
     * @param Boolean $_foreclosureOnApp
     * @return LoanRequestInfo_Type
     */
     ...
     * @param CurrencyAmount $_requestedCreditAmt the RequestedCreditAmt
     ...
     * @param CurrencyAmount $_downPmtAmt the DownPmtAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_monthlyPmtAmt the MonthlyPmtAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_bookValueAmt the BookValueAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_costOfGoodsAmt the CostOfGoodsAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_totalLiquidAssetsAmt the TotalLiquidAssetsAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_mortgageRentAmt the MortgageRentAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_mortgageAmt the MortgageAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_mortgageBalAmt the MortgageBalAmt
     * @return CurrencyAmount
     */
     ...
     * @param CurrencyAmount $_monthlyDebtAmt the MonthlyDebtAmt
     * @return CurrencyAmount
     */
     ...
     * @param Boolean $_bankruptcyOnApp the BankruptcyOnApp
     * @return Boolean
     */
    public function setBankruptcyOnApp($_bankruptcyOnApp)
    {
        if(!Boolean::valueIsValid($_bankruptcyOnApp))
        {
            return false;
        }
     ...
     * @uses Boolean::valueIsValid()
     * @param Boolean $_repossessionOnApp the RepossessionOnApp
     * @return Boolean
     */
    public function setRepossessionOnApp($_repossessionOnApp)
    {
        if(!Boolean::valueIsValid($_repossessionOnApp))
        {
            return false;
        }
     ...
     * @uses Boolean::valueIsValid()
     * @param Boolean $_foreclosureOnApp the ForeclosureOnApp
     * @return Boolean
     */
    public function setForeclosureOnApp($_foreclosureOnApp)
    {
        if(!Boolean::valueIsValid($_foreclosureOnApp))
        {
            return false;
        }
