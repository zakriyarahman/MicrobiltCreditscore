...
/**
 * File for class OtherAmounts_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for OtherAmounts_Type originally named OtherAmounts_Type
 ...
 * @date 2015-11-26
 */
class OtherAmounts_Type extends Aggregate
{
    /**
     * The AmtType
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_otherAmt
    ...
    /**
     * Set OtherAmt value
     * @param CurrencyAmount $_otherAmt the OtherAmt
