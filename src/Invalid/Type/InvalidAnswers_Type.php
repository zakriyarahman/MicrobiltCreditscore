...
/**
 * File for class InvalidAnswers_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for InvalidAnswers_Type originally named InvalidAnswers_Type
 ...
 * @date 2015-11-26
 */
class InvalidAnswers_Type extends Aggregate
{
    /**
     * The InvalidAnswer
     * Meta informations extracted from the WSDL
