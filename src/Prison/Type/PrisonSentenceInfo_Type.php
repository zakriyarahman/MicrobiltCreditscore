...
namespace Zakriyarahman\Microbilt\Prison\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class PrisonSentenceInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for PrisonSentenceInfo_Type originally named PrisonSentenceInfo_Type
 ...
 * @date 2015-11-26
 */
class PrisonSentenceInfo_Type extends Aggregate
{
    /**
     * The AdmittedDt
     * Meta informations extracted from the WSDL
