...
/**
 * File for class CorporateCreditRating_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CorporateCreditRating_Type originally named CorporateCreditRating_Type
 ...
 * @date 2015-11-26
 */
class CorporateCreditRating_Type extends Aggregate
{
    /**
     * The CreditRating
     * Meta informations extracted from the WSDL
     ...
     * @param CreditRating_Type $_creditRating
     * @param CreditRating_Type $_historicalCreditRating
     * @param Message_Type $_message
     * @return CorporateCreditRating_Type
     */
     ...
     * @param CreditRating_Type $_creditRating the CreditRating
     ...
     * @param CreditRating_Type $_historicalCreditRating the HistoricalCreditRating
     * @return CreditRating_Type
     */
