...
/**
 * File for class CodeDescription_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CodeDescription_Type originally named CodeDescription_Type
 ...
 * @date 2015-11-26
 */
class CodeDescription_Type extends MicrobiltWsdlClass
{
    /**
     * The Code
     * Meta informations extracted from the WSDL
