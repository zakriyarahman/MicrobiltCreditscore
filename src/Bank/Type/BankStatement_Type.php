...
/**
 * File for class BankStatement_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for BankStatement_Type originally named BankStatement_Type
 ...
 * @date 2015-11-26
 */
class BankStatement_Type extends Aggregate
{
    /**
     * The StatementDt
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_statementBalAmt
     ...
     * @param CurrencyAmount $_statementBalAmt the StatementBalAmt
