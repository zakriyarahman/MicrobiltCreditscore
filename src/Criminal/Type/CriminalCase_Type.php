...
/**
 * File for class CriminalCase_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CriminalCase_Type originally named CriminalCase_Type
 ...
 * @date 2015-11-26
 */
class CriminalCase_Type extends Aggregate
{
    /**
     * The CaseId
     * Meta informations extracted from the WSDL
     ...
     * @param OrgInfo_Type $_arrestingAgency
     ...
     * @param Charge_Type $_charge
     * @param Message_Type $_message
     * @param PrisonSentenceInfo_Type $_prisonSentenceInfo
     * @param ParoleSentenceInfo_Type $_paroleSentenceInfo
     * @param string $_aACaseId
     * @param Release_Type $_probation
     * @param CurrencyAmount $_fineAmt
     * @param CurrencyAmount $_courtCostsAmt
     ...
     * @param OrgInfo_Type $_arrestingAgency the ArrestingAgency
     * @return OrgInfo_Type
     */
    ...
    /**
     * Set Charge value
     * @param Charge_Type $_charge the Charge
     * @return Charge_Type
     */
     ...
     * @return PrisonSentenceInfo_Type|null
     */
     ...
     * @param PrisonSentenceInfo_Type $_prisonSentenceInfo the PrisonSentenceInfo
     * @return PrisonSentenceInfo_Type
     */
     ...
     * @return ParoleSentenceInfo_Type|null
     */
     ...
     * @param ParoleSentenceInfo_Type $_paroleSentenceInfo the ParoleSentenceInfo
    ...
    /**
     * Set Probation value
     * @param Release_Type $_probation the Probation
     * @return Release_Type
     */
    ...
    /**
     * Set FineAmt value
     * @param CurrencyAmount $_fineAmt the FineAmt
     ...
     * @param CurrencyAmount $_courtCostsAmt the CourtCostsAmt
     * @return CurrencyAmount
     */
