...
/**
 * File for class NeighborhoodResident_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for NeighborhoodResident_Type originally named NeighborhoodResident_Type
 ...
 * @date 2015-11-26
 */
class NeighborhoodResident_Type extends Aggregate
{
    /**
     * The PersonInfo
     * Meta informations extracted from the WSDL
