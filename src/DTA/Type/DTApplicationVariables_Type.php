...
namespace Zakriyarahman\Microbilt\DTA\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class DTApplicationVariables_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for DTApplicationVariables_Type originally named DTApplicationVariables_Type
 ...
 * @date 2015-11-26
 */
class DTApplicationVariables_Type extends Aggregate
{
    /**
     * The AppVarID
     * Meta informations extracted from the WSDL
