...
/**
 * File for class AuthConfig_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for AuthConfig_Type originally named AuthConfig_Type
 ...
 * @date 2015-11-26
 */
class AuthConfig_Type extends Aggregate
{
    /**
     * The NumOfQuestions
     * Meta informations extracted from the WSDL
     ...
     * @param QuestionConfig_Type $_questionConfig
     * @return AuthConfig_Type
     */
     ...
     * @return QuestionConfig_Type|null
     */
     ...
     * @param QuestionConfig_Type $_questionConfig the QuestionConfig
     * @return QuestionConfig_Type
     */
