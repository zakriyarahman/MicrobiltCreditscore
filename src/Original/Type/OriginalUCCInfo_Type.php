...
/**
 * File for class OriginalUCCInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for OriginalUCCInfo_Type originally named OriginalUCCInfo_Type
 ...
 * @date 2015-11-26
 */
class OriginalUCCInfo_Type extends Aggregate
{
    /**
     * The PRStatus
     * Meta informations extracted from the WSDL
