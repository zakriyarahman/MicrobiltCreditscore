...
namespace Zakriyarahman\Microbilt\Category\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class CategoryInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for CategoryInfo_Type originally named CategoryInfo_Type
 ...
 * @date 2015-11-26
 */
class CategoryInfo_Type extends Aggregate
{
    /**
     * The MsgClass
     * Meta informations extracted from the WSDL
