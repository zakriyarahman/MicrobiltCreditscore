...
namespace Zakriyarahman\Microbilt\Summary\Type\SummaryItem_Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class SummaryItem_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for SummaryItem_Type originally named SummaryItem_Type
 ...
 * @date 2015-11-26
 */
class SummaryItem_Type extends Aggregate
{
    /**
     * The SummaryType
     * Meta informations extracted from the WSDL
