...
namespace Zakriyarahman\Microbilt\Filings\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class FilingsInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for FilingsInfo_Type originally named FilingsInfo_Type
 ...
 * @date 2015-11-26
 */
class FilingsInfo_Type extends Aggregate
{
    /**
     * The FilingNum
     * Meta informations extracted from the WSDL
