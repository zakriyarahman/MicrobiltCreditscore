...
/**
 * File for class QuestionConfig_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for QuestionConfig_Type originally named QuestionConfig_Type
 ...
 * @date 2015-11-26
 */
class QuestionConfig_Type extends Aggregate
{
    /**
     * The QuestionID
     * Meta informations extracted from the WSDL
