 ...
 */
/**
 * This class stands for Answers_Type originally named Answers_Type
 ...
 * @date 2015-11-26
 */
class Answers_Type extends Aggregate
{
    /**
     * The AnswerValue
     * Meta informations extracted from the WSDL
     ...
     * @param Boolean $_answerIsCorrect
     * @return Answers_Type
     */
     ...
     * @param Boolean $_answerIsCorrect the AnswerIsCorrect
     * @return Boolean
     */
    public function setAnswerIsCorrect($_answerIsCorrect)
    {
        if(!Boolean::valueIsValid($_answerIsCorrect))
        {
            return false;
        }
