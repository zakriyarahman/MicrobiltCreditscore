...
namespace Zakriyarahman\Microbilt\Inquiry_\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class Inquiry_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for Inquiry_Type originally named Inquiry_Type
 ...
 * @date 2015-11-26
 */
class Inquiry_Type extends Aggregate
{
    /**
     * The InqDt
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_inquiryAmt
     ...
     * @param CurrencyAmount $_inquiryAmt the InquiryAmt
