 ...
 */
/**
 * This class stands for PostAddr_Type originally named PostAddr_Type
 ...
 * @date 2015-11-26
 */
class PostAddr_Type extends Aggregate
{
    /**
     * The StreetName
     * Meta informations extracted from the WSDL
    ...
    /**
     * Set GEOCode value
     * @param GEOCode_Type $_gEOCode the GEOCode
     * @return GEOCode_Type
     */
