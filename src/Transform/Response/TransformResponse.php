...
/**
 * File for class TransformResponse
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for TransformResponse originally named TransformResponse
 ...
 * @date 2015-11-26
 */
class TransformResponse extends MicrobiltWsdlClass
{
    /**
     * The TransformResult
     * Meta informations extracted from the WSDL
