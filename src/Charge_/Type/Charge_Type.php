...
namespace Zakriyarahman\Microbilt\Charge_\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class Charge_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for Charge_Type originally named Charge_Type
 ...
 * @date 2015-11-26
 */
class Charge_Type extends Aggregate
{
    /**
     * The ChargeId
     * Meta informations extracted from the WSDL
