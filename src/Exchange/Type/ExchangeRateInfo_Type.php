...
namespace Zakriyarahman\Microbilt\Exchange\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class ExchangeRateInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for ExchangeRateInfo_Type originally named ExchangeRateInfo_Type
 ...
 * @date 2015-11-26
 */
class ExchangeRateInfo_Type extends Aggregate
{
    /**
     * The ResearchDt
     * Meta informations extracted from the WSDL
