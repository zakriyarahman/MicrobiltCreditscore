...
/**
 * File for class MilitaryIdInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MilitaryIdInfo_Type originally named MilitaryIdInfo_Type
 ...
 * @date 2015-11-26
 */
class MilitaryIdInfo_Type extends Aggregate
{
    /**
     * The MilitaryIdNum
     * Meta informations extracted from the WSDL
