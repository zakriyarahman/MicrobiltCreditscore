...
/**
 * File for class VoterRegistration_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for VoterRegistration_Type originally named VoterRegistration_Type
 ...
 * @date 2015-11-26
 */
class VoterRegistration_Type extends Aggregate
{
    /**
     * The PersonInfo
     * Meta informations extracted from the WSDL
