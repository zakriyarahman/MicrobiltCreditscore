...
/**
 * File for class GetReportResponse
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for GetReportResponse originally named GetReportResponse
 ...
 * @date 2015-11-26
 */
class GetReportResponse extends MicrobiltWsdlClass
{
    /**
     * The GetReportResult
     * Meta informations extracted from the WSDL
     ...
     * @param ExStdRs_Type $_getReportResult
     ...
     * @param ExStdRs_Type $_getReportResult the GetReportResult
     * @return ExStdRs_Type
     */
