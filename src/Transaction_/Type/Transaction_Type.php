...
namespace Zakriyarahman\Microbilt\Transaction_\Type;

use Zakriyarahman\Microbilt\Aggregate\Aggregate;
use Zakriyarahman\Microbilt\MicrobiltWsdlClass;

/**
 * File for class Transaction_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for Transaction_Type originally named Transaction_Type
 ...
 * @date 2015-11-26
 */
class Transaction_Type extends Aggregate
{
    /**
     * The TransNum
     * Meta informations extracted from the WSDL
     ...
     * @param CurrencyAmount $_transAmt
    ...
    /**
     * Set TransAmt value
     * @param CurrencyAmount $_transAmt the TransAmt
